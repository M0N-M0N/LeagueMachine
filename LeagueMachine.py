...
# process video is an ultralytics utility function, needed to recreate it to add more params
def process_video(
        source_path: str,
        target_path: str,
        position: str,
...
class LeagueMachineApp:
    ...
    def analyze(self):
        ...
        process_video(source_path=self.file_path, target_path=f"result.mp4", callback=process_frame, position=position)
...
if __name__ == '__main__':
    # Load the YOLO model
    model = YOLO("yolov8s_loltrained.pt")
